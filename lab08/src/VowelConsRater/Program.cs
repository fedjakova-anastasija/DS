        ...
        static void Main(string[] args)
        {
            ...
            sub.Subscribe(RATER_HINTS_CHANNEL, delegate
            {
                ...
                {                   
                    ...
                    string rankId = "TextStatistics_" + id.Substring(13, id.Length - 13);
                    ...
                    redis.Add(GetDatabaseId(valueFromMainDB), id, ratioNumber.ToString());
                    msg = getDB.ListRightPop(RATER_QUEUE_NAME);
                    redis.Publish($"{rankId}:{ratioNumber}");
                }
            });
